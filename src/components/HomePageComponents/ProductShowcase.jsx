...
const ProductShowcase = () => {
  return (
    <section className="lg:py-2 py-2 " style={{
      ...
      <Slide bottom>
        ...
        <p className="lg:text-2xl p-2 text-xl text-black-100 max-w-xl mx-auto text-center my-10">
          Savor the flavors of Africa at African Soul Food . Join us for a memorable dining experience and explore the culinary wonders of the continent.
